...
KINDS = {
    ...
    "booking_received": "استلام طلب موعد",
    "booking_confirmed": "تأكيد موعد",
    "booking_cancelled": "إلغاء موعد",
    "booking_changed": "تعديل موعد",
    "booking_reminder": "تذكير بموعد",
    "order_received": "استلام طلب خدمات",
    "order_approved": "موافقة على طلب خدمات",
    "order_rejected": "رفض طلب خدمات",
    "order_scheduled": "تحديد موعد طلب خدمات",
    "portal_signup_code": "رمز تأكيد إنشاء حساب بوابة المرضى",
    "portal_email_change_code": "رمز تأكيد تغيير بريد بوابة المرضى",
