...
class ClinicSettingsView(APIView):
    ...
    def payload(self, request, tenant):
        return {
            ...
            # Found by strangers in the public directory (docs/15 §10).
            "listed_in_directory": tenant.listed_in_directory,
    ...
    def patch(self, request):
        ...
        changed = []
        for field in ("portal_show_diagnosis", "portal_self_registration", "portal_allow_other_branches", "listed_in_directory"):
        ...
        if changed:
            ...
            if "listed_in_directory" in changed:
                from api.directory import forget_directory
