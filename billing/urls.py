...
from .views import (
    payment_create, payment_list, payment_detail, payment_update, payment_delete, payment_print, shift_print,
    expense_create, expense_list, expense_update, expense_delete, expense_print,
